...
questions_and_gt = []
with open('./困难数据含答案/math_hard.jsonl', 'r', encoding='utf-8') as f:
    for line in f:
...
# 加载所有响应
with open('./requests_format_math_hard_cot.jsonl', 'r', encoding='utf-8') as f:
    for line in f:
        try:
...
with open('./math_hard_train_with_qwen-max.jsonl', 'w', encoding='utf-8') as f:
